...
urlpatterns = [
    ...
    re_path(r'^Employee_Stress_Prediction_Type/$', remoteuser.Employee_Stress_Prediction_Type, name="Employee_Stress_Prediction_Type"),
    ...
    re_path(r'^View_Employee_Stress_Prediction_Type_Ratio/$', serviceprovider.View_Employee_Stress_Prediction_Type_Ratio, name="View_Employee_Stress_Prediction_Type_Ratio"),
    re_path(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    re_path(r'^View_Employee_Stress_Prediction_Type/$', serviceprovider.View_Employee_Stress_Prediction_Type, name="View_Employee_Stress_Prediction_Type"),
    re_path(r'^Download_Trained_DataSets/$', serviceprovider.Download_Trained_DataSets, name="Download_Trained_DataSets"),
    re_path(r'^Add_Admin/$', serviceprovider.Add_Admin, name="Add_Admin"),
    re_path(r'^View_Admins/$', serviceprovider.View_Admins, name="View_Admins"),
    re_path(r'^Delete_Admin/(?P<admin_id>\d+)/$', serviceprovider.Delete_Admin, name="Delete_Admin"),
